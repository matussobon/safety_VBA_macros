Attribute VB_Name = "Microcircuits"
Sub Split()
...
Range("B" & i + 2).Value = WorksheetFunction.VLookup(Range("A" & i + 2).Value, ws1.Range("A3:AN5000"), 35, 0) 'treba zmenit cislo stlpca v ktorom je part failure rate
Range("C" & i + 2).Value = WorksheetFunction.VLookup(Range("A" & i + 2).Value, ws1.Range("A3:AN5000"), 3, 0)
Next
...
Sub IC_CALC()
Attribute IC_CALC.VB_ProcData.VB_Invoke_Func = "q\n14"
